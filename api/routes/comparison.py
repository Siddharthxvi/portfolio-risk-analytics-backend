...
def compare_runs(
    ...
    query = db.query(
        ...
        Portfolio, SimulationRun.portfolio_id == Portfolio.portfolio_id
    ).join(
        Scenario, SimulationRun.scenario_id == Scenario.scenario_id
    ).join(
        RiskMetric, SimulationRun.run_id == RiskMetric.run_id
